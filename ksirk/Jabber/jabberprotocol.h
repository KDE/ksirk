...
class JabberProtocol: public QObject
{
	Q_OBJECT
...
// 	const Kopete::PropertyTmpl propAbout;
	 ...
	 */
	OnlineStatus resourceToOS ( const XMPP::Resource &resource );
	
	/**
	 * Convert an online status to a  XMPP::Status
	 */
	XMPP::Status osToStatus( const OnlineStatus & status, const QString& message=QString() );
