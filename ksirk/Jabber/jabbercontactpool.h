...
public:
	 ...
	 */
	JabberBaseContact *addContact ( const XMPP::RosterItem &contact, bool dirty = true  );
	JabberBaseContact *addGroupContact ( const XMPP::RosterItem &contact, bool roomContact, bool dirty = true );
...
private slots:
	void slotContactDestroyed ( JabberBaseContact *contact );
